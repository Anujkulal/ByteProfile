...
const buttonVariants = cva(
  "cursor-pointer active:scale-95 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
  default:
  ...
  generate:
    "bg-gradient-to-r from-green-500 via-blue-600 to-purple-700 text-white shadow-md hover:from-green-500 hover:to-purple-700 transition-all duration-400 ease-in-out",
},
      size: {
